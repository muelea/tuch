...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--num_epochs', type=int, default=6, help='Total number of training epochs')
        ...
        train.add_argument('--summary_freq', type=float, default=0.5, help='Summary (tensorboard training images) saving frequency')
        train.add_argument('--val_and_checkpoint_freq', type=float, default=0.5, help='Validation and checkpoint saving frequency, default (0.5) runs 2 evaluations per epoch. 0.0 does not run evaluations. 1.0 evaluates one time per epoch.')
        ...
        # training data
        train.add_argument('--ds_names', nargs='+', type=str, default=['dsc', 'mtp'], help='Names of datasets to use in training.')
        train.add_argument('--ds_composition', nargs='+', type=float, default=[0.5, 0.5], help='Proportion of data per batch (follows order as ds_name).')
        ...
        train.add_argument('--contact_loss_weight', default=1e-5, type=float, help='weight for contact loss in regressor')
        train.add_argument('--openpose_train_weight', default=1., type=float, help='Weight for OpenPose keypoints during training')
